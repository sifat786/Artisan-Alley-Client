  ...
  return (
    <div>
      ...
      <div className="w-full max-w-2xl p-4 rounded-md md:p-12 shadow-lg mx-auto bg-gradient-to-r from-purple-300 to-blue-300 my-10 md:my-[70px] lg:my-[100px] container">
        <h1 className="text-center text-2xl md:text-[35px] font-semibold bg-gradient-to-r from-orange-500 via-indigo-500 to-green-500 text-transparent bg-clip-text mb-5">SignIn</h1>

        <form onSubmit={handleSubmit(handleSignIn)} className="space-y-6">
          <div className="space-y-1 text-sm">
            <label htmlFor="username" className="block text-base md:text-xl font-bold">
              Email
            </label>
            <input
              type="email"
          ...
          <input
            type="submit"
            value="Sign In"
            className="w-full px-8 py-3 font-semibold rounded-md bg-gray-500 cursor-pointer"
          />
        </form>
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
          <p className="px-3 text-xl text-gray-600 font-bold">
        ...
        <p className="text-sm text-center sm:px-6">
          ...
          <Link to={`/signup`} className="text-red-500 underline font-bold">
            Sign Up
          </Link>
        </p>
      </div>
